...
#define LOG_TAG "Lt03LtePowerHAL"
#include <utils/Log.h>

#include <hardware/hardware.h>
#include <hardware/power.h>

#define GRIP_SENSOR_POWER          "/sys/class/input/input0/enabled"
#define LIGHT_SENSOR_POWER         "/sys/class/input/input1/enabled"
#define MAGNETIC_SENSOR_POWER      "/sys/class/input/input2/enabled"
#define GYRO_SENSOR_POWER          "/sys/class/input/input3/enabled"
#define ACCELEROMETER_SENSOR_POWER "/sys/class/input/input4/enabled"
#define QPNP_PON_POWER             "/sys/class/input/input5/enabled"
#define E_PEN_POWER                "/sys/class/input/input6/enabled"
#define TOUCHSCREEN_POWER          "/sys/class/input/input7/enabled"
#define GPIO_KEYS_POWER            "/sys/class/input/input8/enabled"
#define MHL_POWER                  "/sys/class/input/input9/enabled"
...
static void power_set_interactive(__attribute__((unused)) struct power_module *module, int on)
{
    ...
    sysfs_write(GRIP_SENSOR_POWER,          on ? "1" : "0");
    sysfs_write(LIGHT_SENSOR_POWER,         on ? "1" : "0");
    sysfs_write(MAGNETIC_SENSOR_POWER,      on ? "1" : "0");
    sysfs_write(GYRO_SENSOR_POWER,          on ? "1" : "0");
    sysfs_write(ACCELEROMETER_SENSOR_POWER, on ? "1" : "0");
    sysfs_write(QPNP_PON_POWER,             on ? "1" : "0");
    sysfs_write(E_PEN_POWER,                on ? "1" : "0");
    sysfs_write(TOUCHSCREEN_POWER,          on ? "1" : "0");
    sysfs_write(GPIO_KEYS_POWER,            on ? "1" : "0");
    sysfs_write(MHL_POWER,                  on ? "1" : "0");
}
